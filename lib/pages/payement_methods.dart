                  ...
                  return Card(
                    ...
                    child: ListTile(
                      leading: item['icon'] != null
                          ...
                          : Image(
                              image: item[
                                  'image'], // Afficher l'image de la méthode de paiement
                            ),
                      title: Text(item[
                          'title']), // Afficher le titre de la méthode de paiement
                      trailing: Icon(Icons
                          .arrow_forward), // Icône pour indiquer que l'utilisateur peut cliquer pour en savoir plus
                      onTap: () {
